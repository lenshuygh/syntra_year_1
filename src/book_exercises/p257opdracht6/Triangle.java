...
public class Triangle extends Shape {
    ...
    public void setHeight(int height) throws NegativeSizeException {
        if (height < 0) {
            throw new NegativeSizeException("Triangle height cannot be negative.");
        }
    ...
    public void setWidth(int width) throws NegativeSizeException {
        if (width < 0) {
            throw new NegativeSizeException("Triangle width cannot be negative.");
        }
    ...
    public void setPerpendicular(int perpendicular) throws NegativeSizeException {
        if (perpendicular < 0) {
            throw new NegativeSizeException("Triangle's perpendicular cannot be negative");
        }
